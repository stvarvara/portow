...
// Подключаем Intersection Observer
...
// Находим все элементы .services__item и секции .section
const servicesItems = document.querySelectorAll('.services__item');

// Добавляем каждый элемент и секцию в наблюдатель
...
// Находим все элементы .portfolio__item
